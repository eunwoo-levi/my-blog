...
export default function PostCard({ post }: postProps) {
  return (
    <Link
      ...
      key={post.title}
      className="flex items-center w-full lg:w-[800px] min-h-[280px] p-8 rounded-xl shadow-md border border-slate-800 dark:hover:border-white dark:hover:bg-gray-900 transition-all duration-300  hover:shadow-2xl"
    >
      <img
        src={post.thumbnail}
        alt="thumbnail"
