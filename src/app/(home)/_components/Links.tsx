...
const customLinkClassName =
  'flex justify-center font-semibold  items-center w-[300px] lg:w-[500px] h-[50px] border rounded-3xl transform duration-300 hover:bg-slate-700 hover:bg-opacity-30 hover:scale-110 cursor-pointer';
