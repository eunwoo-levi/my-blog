...
![](https://velog.velcdn.com/images/eunwoo1341/post/5a1d642a-9f00-4710-9642-ab9d26b3ad09/image.png)
...
(1)  Load 명령어의 CPI가 5에서 2로 개선되므로,  5/2 = 2.5 배가 개선된다.
(2)  Load 명령어는 전체 명령어의 20%를 차지합니다.
(3) Aldahl’s Law 법칙 공식을 적용하면 ..

전체 속도 향상 =
1 / ((1 - 0.2) + (0.2 / 2.5)) = 1 / (0.8 + 0.08) = 1 / 0.88 ≈ 1.136

성능 향상을 백분율로 표현: 성능 향상 = (1.136 - 1) * 100% ≈ 13.6%

따라서, Load 명령어의 CPI를 5에서 2로 개선함으로써 얻을 수 있는 전체 시스템의 성능 향상은 약 13.6%입니다.
