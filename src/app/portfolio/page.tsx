...
import { profileData, extracurricularData, experienceData, ProfileProps, ActivityProps } from './data';
...
const ProfileSection = ({ data }: ProfileSectionProps) => (
  <div className='flex flex-col justify-center gap-y-[30px] md:gap-y-[40px] bg-white p-6 md:p-8 rounded-lg shadow-lg'>
    ...
    <div className='grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6'>
      ...
      <div className='flex items-center gap-2 md:gap-3'>
        ...
        <div className='flex flex-col'>
          ...
          <h2 className='text-[16px] md:text-[18px] text-gray-600'>{data.major}</h2>
        </div>
      </div>
    </div>
    ...
    <div className='bg-gray-700/20 flex flex-col items-center gap-4 p-4 rounded-lg mt-8'>
      <h1 className='text-indigo-900 text-[24px] md:text-[30px] font-bold'>⚡ Main Stack ⚡</h1>
...
const ActivitySection: React.FC<ActivitySectionProps> = ({ data, title }) => (
  <div className='flex flex-col justify-center gap-y-[30px] md:gap-y-[40px] bg-white p-6 md:p-8 rounded-lg shadow-lg'>
    ...
    <div className='w-full'>
      <table className='w-full table-fixed divide-y divide-gray-200' aria-label={title}>
      ...
      <div className='w-full flex flex-col justify-center items-center gap-6 md:gap-8 px-4 lg:px-0 mb-16 md:mb-20 z-20'>
        <div className='w-full max-w-screen-lg bg-white py-6 rounded-lg'>
          ...
          <div className='text-center'>
            <h1 className='text-indigo-900 text-[22px] md:text-[24px] font-bold'>EunWoo Seong</h1>
            <h2 className='text-[16px] md:text-[18px] text-indigo-600'>Frontend Developer</h2>
        ...
        <div className='w-full max-w-screen-lg px-4 md:px-10 space-y-6 md:space-y-8'>
          ...
          <ActivitySection data={extracurricularData} title='Extracurricular Activities' />
