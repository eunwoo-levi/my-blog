...
description: 'Next.js 프로젝트에 Sentry 도입하기. 실시간 에러 모니터링, 성능 추적(APM), Session Replay 기능 구현과 트러블슈팅 완벽 가이드.'
---
...
Sentry에 대한 자세한 내용은 [Sentry 공식 문서](https://docs.sentry.io/platforms/javascript/guides/nextjs)와 여러 해외 글들을 참고하였다.
