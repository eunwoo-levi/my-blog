---
title: '[React] 웹인데 앱처럼: React PWA 구현하여 FCM 푸시 알림 적용하기'
author: 'Eunwoo'
...
description: 'React 웹 서비스에 PWA와 FCM을 적용하여 앱처럼 사용하는 방법. 홈 화면 추가, 오프라인 지원, 실시간 푸시 알림 구현까지 실제 Moment 서비스 적용 사례로 알아봅니다.'
---
...
![](https://velog.velcdn.com/images/eunwoo1341/post/e0de6c4a-9e87-4d30-9bda-4d8d5ef240e2/image.png)
