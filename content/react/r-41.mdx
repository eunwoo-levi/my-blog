...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', margin: '2rem 0' }}>
  <div>
    ...
    <video width='100%' controls>
      <source
        src='https://github.com/user-attachments/assets/34bd2619-6265-42ff-a0a7-1895b6ab5349'
        type='video/mp4'
      />
  ...
  <div>
    ...
    <video width='100%' controls>
      <source
        src='https://github.com/user-attachments/assets/106778c8-9ad8-4fd5-8c01-f0160d2d6a38'
        type='video/mp4'
      />
      브라우저가 video 태그를 지원하지 않습니다.
    </video>
...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', margin: '2rem 0' }}>
  <div>
    ...
    <video width='100%' controls>
      <source
        src='https://github.com/user-attachments/assets/5b6db40e-c27e-4bb4-9413-e273e1e4481a'
        type='video/mp4'
      />
      브라우저가 video 태그를 지원하지 않습니다.
    </video>
  ...
  <div>
    ...
    <video width='100%' controls>
      <source
        src='https://github.com/user-attachments/assets/4b276711-afe1-40db-ae14-75ed20ec6bd4'
        type='video/mp4'
      />
      브라우저가 video 태그를 지원하지 않습니다.
    </video>
