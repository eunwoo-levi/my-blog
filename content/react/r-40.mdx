...
![](https://velog.velcdn.com/images/eunwoo1341/post/45e74cc3-c07e-4ee8-8e46-ac431de18980/image.png)

`실제 UI와 동일 크기의 스켈레톤`과 `지연 렌더링` 조합 덕분에, 빠른 환경에서는 플리커·CLS 없이 바로 실제 UI가 나타나고, 느린 환경에서는 스켈레톤이 자연스럽게 등장하여 로딩 안내 역할을 한다.
