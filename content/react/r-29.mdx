...
description: 'React에서 SSE(Server-Sent Events)로 실시간 데이터 받기. EventSource를 활용한 서버 푸시 구현, WebSocket과 Polling 비교, 실전 활용 가이드.'
---
...
![](https://velog.velcdn.com/images/eunwoo1341/post/0b1671ac-2937-458f-ba2a-0fb692c8855f/image.png)
